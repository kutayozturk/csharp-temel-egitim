...
//	float : Uzunluğu 4 byte’tır, 1.5 x 10-45 ile 3.4 x 1038 arasında değer alır.
		float ondalikliSayi1 = 15.4f;	// f harfi float veri tipi olduğunu belirtir.
	
//	double : Uzunluğu 8 byte’tır, 5.0 x 10-324 ile 1.7 x 10308 arasında değer alır.
		double ondaliklisayi2 = 13.5;

//	decimal : Uzunluğu 12 byte’tır, ±1.0 x 10-28 ile ±7.9 x 1028 arasında değer alır.
		demical ondalikliSayi3 = 4.3m; // m harfi decimal veri tipi olduğunu belirtir.
...
// DateTime
		DatetTime zaman = DateTime.Now; 	// Şuanki tarih ve saati ekrana yazdırır
		DatetTime zaman = DateTime.UtcNow; 	// 
